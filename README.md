...
[![Platform](https://img.shields.io/badge/platform-macOS-black.svg?style=flat-square)](https://www.apple.com/macos/)
...
<div align="center">
  <img width="600" src="https://via.placeholder.com/600x400/1a1a1a/ffffff?text=Agent+Nightshift+Demo" alt="Demo">
</div>
...
```mermaid
graph LR
    A[Write PRD] --> B[Submit Task]
    B --> C[AI Analysis]
    C --> D[Autonomous Execution]
    D --> E[Wake Up to Results! 🎉]
...
<tr>
<td align="center">
<img width="400" src="https://via.placeholder.com/400x300/1a1a1a/ffffff?text=PRD+Editor" alt="PRD Editor"><br>
<b>PRD Editor</b>
</td>
<td align="center">
<img width="400" src="https://via.placeholder.com/400x300/1a1a1a/ffffff?text=Workflow+View" alt="Workflow View"><br>
<b>Live Workflow</b>
</td>
</tr>
</table>
...
**Built with ❤️ for developers who value their sleep**
